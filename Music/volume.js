...
execute(message, args) {
    ...
    message.react("<:voice:891421242777821194>");
    ...
    .setColor("#146DF6")
    .setTitle(`<:voice:891421242777821194> Volume is: \`${queue.volume}%\``)
    ...
    .setColor("#146DF6")
    .setTitle(`<:voice:891421242777821194> Volume changed to: \`${args[0]}%\`!`)
